...
public class Ttl74161ChipTests
{
    private static void Pulse(Ttl74161Chip chip)
    {
        chip.Clk = true;
        chip.Clk = false;
    }
    ...
    {
        var chip = new Ttl74161Chip { Enp = true, Ent = true };
    ...
    [Test]
    public async Task WrapsFromFifteenToZero()
    {
        var chip = new Ttl74161Chip { Enp = true, Ent = true };
    ...
    {
        var chip = new Ttl74161Chip { Enp = false, Ent = true };
    ...
    {
        var chip = new Ttl74161Chip { Enp = true, Ent = false };
    ...
    {
        var chip = new Ttl74161Chip { Enp = true, Ent = true, Clr = false };
